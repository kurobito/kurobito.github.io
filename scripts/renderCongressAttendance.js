...
import {sortByFirstNameAscending, sortByFirstNameDescending, sortByMissedVotesAscending
...
const congressEngagedTables = new Vue({
	...
	methods:{
		...
		sortByNumOfMissedVotes: function(event){
			const sortStringAscendingly = '# of missed votes <i class="fas fa-sort-up no-pointer-event">'
			const sortStringDescendingly = '# of missed votes <i class="fas fa-sort-down no-pointer-event">'
			const leastEngagedHeaderRow = document.getElementById('leastEngagedHeader');
			const mostEngagedHeaderRow = document.getElementById('mostEngagedHeader');
			const isLeastEngagedTable = leastEngagedHeaderRow === event.target.parentElement;
